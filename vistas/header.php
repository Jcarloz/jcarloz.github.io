...
<head>
  ...
  <title>CODING01 | Escritorio</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>CODING</b> 01</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SISTEMA</b>CODING01</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  JOSE CARLOS CARRILLO AYUD-Desarrollo de software
                  <small>SEPTIEMPRE 2022</small>
                </p>
              </li>
              <!-- Menu Footer-->
